...
def solve(solverBoard, solverHand):
    d = drawPile()
    b = board()
    ...
    for i in range(106):
        solver.draw(d)
    print(len(solverBoard))
    if (len(solverBoard) > 0):
    ...
    while True:
        if (len(solverBoard) == 0):
            print("oooonn")
            grp, new = goingOutSolver(solver.hand)
#             print(groupsToAdd)
#             print(list_group)
#             print(newHand)
#             if not groupsToAdd == None:
#                 b.addGroups(grp)
#                 solver.removeItemsFromHand(new)
#                 b.displayBoard()
#                 solver.displayHand()
        else:
            print("innnnn")
            grp, new = dannySolver(solver.hand, b.selectAllGroups())
#             print(groupsToAdd)
#             print(list_group)
#             print(newHand)
#             if grp != None:
